...
public class CartTest {
    ...
    public void testGetCart() {
        ...
        cart_1.addProductToCart(ten_wings, 3);
        assertNotNull(cart_1.getCart());
    }
    ...
    public void testAddProduct() {
        ...
        assertTrue(cart_1.addProductToCart(ten_wings, 1));
        assertFalse(cart_1.addProductToCart(ten_wings, 2));
        assertTrue(cart_1.removeProductFromCart(ten_wings, 2));
        assertFalse(cart_1.removeProductFromCart(ten_wings, 3));
        assertFalse(cart_1.addProductToCart(tender_combo, 8));
    ...
    public void testRemoveProduct() {
        ...
        assertTrue(cart_1.addProductToCart(ten_wings, 3));
        assertTrue(cart_1.removeProductFromCart(ten_wings, 1));
        assertTrue(cart_1.removeProductFromCart(ten_wings, 2));
