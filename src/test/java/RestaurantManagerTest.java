...
public class RestaurantManagerTest {
    ...
    public void testProductMap() {
        ...
        assertNotEquals(mcDonaldController.ProductMap(mcDonald.getRestaurantMenu()).get("2"), mc_flurry);
    ...
    public void testFindProduct() {
        ...
        assertNotEquals(mcDonaldController.findProduct("2"), mc_flurry);
    ...
    public void testContainProduct() {
        ...
        assertFalse(mcDonaldController.containProduct("2"));
